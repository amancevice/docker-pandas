...
docker tag amancevice/pandas:0.19-python2 amancevice/pandas:0.19.1-python2
docker tag amancevice/pandas:0.19-python2 amancevice/pandas:0.19.1
docker tag amancevice/pandas:0.19-python2 amancevice/pandas:0.19
docker build -t amancevice/pandas:$pd-jupyter $pd/jupyter
docker tag amancevice/pandas:0.19-jupyter amancevice/pandas:0.19.1-jupyter
docker tag amancevice/pandas:0.19-python3 amancevice/pandas:0.19.1-python3
